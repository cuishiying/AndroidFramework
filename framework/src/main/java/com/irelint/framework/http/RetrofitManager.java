...
public class RetrofitManager {
    ...
    private RetrofitManager(int hostType) {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl(Constants.getHost(hostType))
    ...
    private final Interceptor mRewriteCacheControlInterceptor = new Interceptor() {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            if (!NetworkUtils.isAvailableByPing(BaseApplication.getAppContext())) {
    ...
    public Observable<Result<Object>> refreshToken(Map<String, String> map){
        return mUrlService.refreshToken(map);
    }
}
